...
namespace TakipSistemi.Web.Templates
{
    public class ModuleModel
    {
        ...
        public ModuleModel(String model, String controller, String area)
        {
            ...
            ControllerTestsNamespace = "TakipSistemi.Tests.Unit.Controllers" + (!String.IsNullOrWhiteSpace(area) ? $".{area}" : "");
            ControllerNamespace = "TakipSistemi.Controllers" + (!String.IsNullOrWhiteSpace(area) ? $".{area}" : "");
